...
function Main() {
  ...
  const [allParticipants, selAllParticipants] = useState<ParticipantType[]>([
    ...participants,
  ]);
    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        {game.isActive && (
          <button
            className={`${
              selectedParticipant ? "btn-rounded--pink" : "btn-rounded--disable"
            }`}
            onClick={() =>
        ...
        <span>Feito com carinho por Gabriel Godoy</span>
      </div>
    </main>
  );
}
